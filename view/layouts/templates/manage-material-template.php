            ...
            <tbody>
                ...
                ?>
                    ...
                    <form method="post" action="">
                        <td> <input type="hidden" name="userId" value="<?php echo  $infoMaterial['Material_Id']; ?>"> </td>
                        ...
                        <td class="btn-tabla-container">
                            ...
                            <button type="submit" name="btnupdate" value="habilitar" class="btn btn-primary btn-tabla">Habilitar</button>
                            <button type="submit" name="btnupdate" value="deshabilitar" class="btn btn-primary btn-tabla">Deshabilitar</button>
